describe('클릭 이벤트와 뷰 화면을 처리하는 클래스입니다.', () => {
    it('viewManager 에 TextManager의 인스턴스가 잘 전달되었는지 확인합니다.', () => {
        ...
        // 유닛 테스트에서의 actual은 테스트 중인 함수 혹은 코드의 반환 값을 의마하는 용어입니다. 함수 형태로 넣어야 잘 작동한다.
    ...
    it('viewManager 에 option들이 제대로 전달되었는지 확인합니다.', () => {
        const btnEl = null;
        const inpTxt = null;
        const viewerEl = null;
    ...
    it('click 이벤트가 발생했을 경우 changeValue 함수가 잘 실행되었는지 확인합니다.', () => {
